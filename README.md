# Spigot server with Dynmap and Essentials

This repository was lifted wholesale from https://github.com/ashdev/docker-spigot/ with minor changes to fit my Rancher configuration.

## To build

`docker build -t mathuin/spigot .`
`docker push mathuin/spigot`
...
To simply use the latest stable version, run
    ...
    docker run -d -p 25565:25565 mathuin/spigot
...
Speaking of multiple servers, it's handy to give your containers explicit names using `--name`, such as
    ...
    docker run -d -p 25565:25565 --name mc mathuin/spigot
...
In order to attach and interact with the Minecraft server, add `-it` when starting the container, such as
    ...
    docker run -d -it -p 25565:25565 --name mc mathuin/spigot
...
such as
    ...
    docker run -d -it -e EULA=TRUE -p 25565:25565 mathuin/spigot
